...
public:
	...
	static inline UINT framePhase = 0;
	...
	std::vector<Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>> mFrameCmdLists;
	std::vector<Microsoft::WRL::ComPtr<ID3D12CommandAllocator>> mFrameCmdAllocs;
